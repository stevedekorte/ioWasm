...
size_t List_size(const List *self) { return self->size; }
...
void List_removeIndex_toIndex_(List *self, size_t index1,
                                        size_t index2) {
    size_t length;
